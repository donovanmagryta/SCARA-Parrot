...
int potpinelbow = 0;  // A0 analog pin used to connect the elbow potentiometer
int potpinshoulder = 1; // A1 analog pin used to connect the shoulder potentiometer
...
  servoelbow.attach(9); // attaches the servo on pin D9 to the servo object
  servoshoulder.attach(10); // attached the servo on pin D10 to the servo object
}
